...
if __name__ == "__main__":
    ...
    hand_drawn_image_path = r'C:\Users\BezylMophatOtieno\source\repos\FreeCAD-models\combination-lock\model_pipeline\output\images\axis-3-digits-hand-drawn.png'
